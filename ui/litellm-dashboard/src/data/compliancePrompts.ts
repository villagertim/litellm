...
export const airlineCompliancePrompts: CompliancePrompt[] = [
  ...
  // =====================
  {
    ...
    categoryIcon: "✈️",
    categoryDescription:
      "User is asking about a travel destination, not a competitor airline.",
...
const frameworkMeta: Record<string, { icon: string; description: string }> = {
  "EU AI Act": {
    icon: "shield",
    description:
      "Article 5 prohibited AI practices under the European Union AI Act.",
  },
  GDPR: {
    icon: "lock",
    description:
      "General Data Protection Regulation — data privacy and protection requirements.",
  },
  "Topic Blocking": {
    icon: "shield",
    description:
  ...
  "Airline Brand Protection": {
    icon: "plane",
    description:
      "Destination vs competitor intent — avoid answering competitor comparison questions.",
  },
