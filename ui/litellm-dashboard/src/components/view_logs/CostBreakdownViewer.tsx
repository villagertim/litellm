  ...
  const hasMeaningfulData =
    ...
    (costBreakdown &&
      ((costBreakdown.discount_percent !== undefined &&
        costBreakdown.discount_percent !== 0) ||
        (costBreakdown.discount_amount !== undefined &&
          costBreakdown.discount_amount !== 0) ||
                        ...
                        <>
                          ...
                          {(costBreakdown?.cache_read_cost ?? 0) > 0 && (
                            <div className="flex text-sm">
                              ...
                              <span className="text-gray-900">
                                {formatCost(
                                  isCached ? 0 : costBreakdown?.cache_read_cost,
                                )}
                                {(cacheReadTokens ?? 0) > 0 && (
                                  <span className="text-gray-500 font-normal ml-1">
                            ...
                            <div className="flex text-sm">
                              ...
                              <span className="text-gray-900">
                                {formatCost(
                                  isCached
                                    ? 0
                                    : costBreakdown?.cache_creation_cost,
                                )}
                ...
                {!isCached && (
                  <div className="pt-2 border-t border-gray-100 max-w-2xl">
                    <div className="flex text-sm font-semibold">
                      <span className="text-gray-900 w-1/3">
                        Original LLM Cost:
                      </span>
                      <span className="text-gray-900">
                        ...
                        {costBreakdown.discount_percent !== undefined &&
                          costBreakdown.discount_percent !== 0 && (
                            <div className="flex text-sm text-gray-600">
                              ...
                              <span className="text-gray-900">
                                -{formatCost(costBreakdown.discount_amount)}
                              </span>
                            </div>
                          )}
                        {costBreakdown.discount_amount !== undefined &&
                        ...
                        {costBreakdown.margin_percent !== undefined &&
                          costBreakdown.margin_percent !== 0 && (
                            <div className="flex text-sm text-gray-600">
                              <span className="font-medium w-1/3">
                                Margin (
                                {formatPercent(costBreakdown.margin_percent)}):
                              </span>
                              <span className="text-gray-900">
                                +
                                {formatCost(
                        ...
                        {costBreakdown.margin_fixed_amount !== undefined &&
                          costBreakdown.margin_fixed_amount !== 0 && (
                            <div className="flex text-sm text-gray-600">
                              ...
                              <span className="text-gray-900">
                                +{formatCost(costBreakdown.margin_fixed_amount)}
                              </span>
                            </div>
                          )}
                      </div>
