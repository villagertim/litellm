import { Button, Card, Grid, TableCell, Text, TextInput } from "@tremor/react";
                        ...
                        <li key={key} className="mx-2 my-2">
                          ...
                          <p style={{ fontSize: "small", fontStyle: "italic" }}>
                            ...
                            {key === "TEST_EMAIL_ADDRESS" && (
                              <div style={{ color: "gray" }}>
                                Email Address to send `Test Email Alert` to.
                                example: `info@berri.ai`
                                <span style={{ color: "red" }}>
                                  {" "}
                                  Required *{" "}
                                </span>
                            ...
                            {key === "EMAIL_LOGO_URL" && (
                              <div style={{ color: "gray" }}>
                                (Optional) Customize the Logo that appears in
                                the email, pass a url to your logo
                              </div>
                            )}
                            {key === "EMAIL_SUPPORT_CONTACT" && (
                              <div style={{ color: "gray" }}>
                                (Optional) Customize the support email address
                                that appears in the email. Default is
                                support@berri.ai
                              </div>
                            )}
                          </p>
