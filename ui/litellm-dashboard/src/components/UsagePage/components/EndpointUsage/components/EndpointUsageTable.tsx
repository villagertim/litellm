...
import type { MetricWithMetadata } from "../../../types";
...
const EndpointUsageTable: React.FC<EndpointUsageTableProps> = ({
  ...
  const dataSource: EndpointRow[] = Object.entries(endpointData).map(
    ([endpoint, data]) => ({
      key: endpoint,
      endpoint,
    ...
    },
    {
      ...
      render: (_: any, record: EndpointRow) => {
        ...
        const failurePercentage =
          record.api_requests > 0
            ? (record.failed_requests / record.api_requests) * 100
            : 0;
        ...
        strokeColorConfig["100%"] =
          failurePercentage > 0 ? "#ef4444" : "#22c55e";
