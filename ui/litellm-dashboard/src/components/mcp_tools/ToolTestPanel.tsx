...
import type { InputSchema, InputSchemaProperty, MCPTool } from "./types";

const isPlainObject = (value: unknown): value is Record<string, any> =>
  typeof value === "object" && value !== null && !Array.isArray(value);

function buildArrayItems(
  items?: InputSchemaProperty | InputSchemaProperty[],
): any[] {
  if (!items) {
    return [];
  }
...
function buildDefaultValue(
  ...
  const effectiveDefault =
    overrideDefault !== undefined ? overrideDefault : prop.default;
  ...
  if (prop.type === "array") {
    if (Array.isArray(effectiveDefault)) {
      ...
      return effectiveDefault.map((value) =>
        buildDefaultValue(itemSchema, value),
      );
    }
...
export function ToolTestPanel({
  ...
  const [viewMode, setViewMode] = React.useState<"formatted" | "json">(
    "formatted",
  );
        ...
        switch (prop.type) {
          ...
          case "array": {
            try {
              ...
              const isValidArray =
                prop.type === "array" && Array.isArray(parsed);
              if (
                ...
                <div className="space-y-3">
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter input for this tool",
                      },
                    ]}
                    className="mb-3"
                  >
              ...
              <div className="flex flex-col justify-center items-center h-48 text-gray-500">
                <div className="text-center max-w-sm">
                  ...
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Configure the input parameters and click &quot;Call
                    Tool&quot; to see the results here.
                  </p>
                </div>
              </div>
            ) : (
                                          ...
                                          (
                                            ...
                                            if (section.startsWith("##")) {
                                              ...
                                              return (
                                                <div
                                                  key={sectionIndex}
                                                  className="border-b border-gray-200 pb-1 mb-2"
                                                >
                                                  <h3 className="text-sm font-semibold text-gray-900">
                                                    {headerText}
                                                  </h3>
