...
import { callMCPTool, listMCPTools } from "../networking";
            ...
            <div className="flex flex-col flex-1">
              ...
              {hasExtraHeaders && (
                <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  ...
                  {!showHeaderInput &&
                    Object.keys(passthroughHeaders).length === 0 && (
                      <Text className="text-xs text-blue-700">
                        This server requires additional headers. Click
                        &quot;Configure&quot; to provide values.
                      </Text>
                    )}
                  ...
                  {showHeaderInput && (
                    <div className="mt-3 space-y-2">
                      ...
                      <AntdButton
                        ...
                        disabled={Object.values(passthroughHeaders).every(
                          (v) => !v || !v.trim(),
                        )}
                    ...
                    Object.keys(passthroughHeaders).length > 0 && (
                      <div className="mt-2">
                        <Text className="text-xs text-green-700 flex items-center">
                          ...
                          {Object.keys(passthroughHeaders).length} header(s)
                          configured
                        </Text>
                      </div>
                    )}
              ...
              {!selectedTool ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-gray-400">
                  ...
                  <Text className="text-center text-gray-500 max-w-md">
                    Choose a tool from the left sidebar to start testing its
                    functionality with custom inputs.
                  </Text>
                </div>
              ) : (
                /* Tool Test Panel */
