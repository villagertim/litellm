...
import type { EntityType, ExportScope } from "./types";
      ...
      >
        <div className="space-y-2">
          <label className="flex items-start p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
            ...
            <div className="ml-3 flex-1">
              <div className="font-medium text-sm">
                Day-by-day breakdown by {entityType}
              </div>
              <div className="text-xs text-gray-500 mt-0.5">
                Daily metrics for each {entityType}
              </div>
            </div>
          </label>
          ...
          <label className="flex items-start p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
            ...
            <div className="ml-3 flex-1">
              <div className="font-medium text-sm">
                Day-by-day breakdown by {entityType} and key
              </div>
              <div className="text-xs text-gray-500 mt-0.5">
                Daily metrics for each {entityType}, split by API key
              </div>
            </div>
          </label>
          ...
          <label className="flex items-start p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
            ...
            <div className="ml-3 flex-1">
              <div className="font-medium text-sm">
                Day-by-day by {entityType} and model
              </div>
              <div className="text-xs text-gray-500 mt-0.5">
                Daily metrics split by model
              </div>
            </div>
          </label>
        </div>
