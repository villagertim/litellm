...
describe("ExportTypeSelector", () => {
  ...
  it("should display entity type in radio labels", () => {
    ...
    expect(
      screen.getByText(/Day-by-day breakdown by team$/),
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Day-by-day breakdown by team and key/),
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Day-by-day by team and model/),
    ).toBeInTheDocument();
  });
  ...
  it("should display the correct entity type for different entities", () => {
    ...
    expect(
      screen.getByText(/Day-by-day breakdown by organization$/),
    ).toBeInTheDocument();
  });
  ...
  it("should call onChange when a radio option is selected", async () => {
    ...
    await user.click(
      screen.getByRole("radio", {
        name: /Day-by-day breakdown by team and key/i,
      }),
    );
  ...
  it("should have the correct radio checked", () => {
    ...
    expect(
      screen.getByRole("radio", { name: /Day-by-day by team and model/i }),
    ).toBeChecked();
  });
});
