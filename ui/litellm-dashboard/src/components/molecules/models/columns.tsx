    ...
    <Space direction="vertical" size={8}>
      ...
      <Flex align="center" gap={8}>
        <Space direction="vertical" size={8}>
          <Flex align="center" gap={8}>
            <EditOutlined
              style={{ color: "#8c8c8c", fontSize: 14, flexShrink: 0 }}
            />
          ...
          <Text type="secondary">
            Credentials added directly during model creation or defined in the
            config file.
          </Text>
        </Space>
      </Flex>
          ...
          <div className="flex items-start space-x-2 min-w-0 w-full cursor-pointer">
            ...
            <div className="flex flex-col min-w-0 flex-1">
              ...
              <Text
                ellipsis
                type="secondary"
                style={{ fontSize: 12, lineHeight: "16px", marginTop: 2 }}
              >
                {model.litellm_model_name || "-"}
              </Text>
            </div>
