        ...
        <TabPanels>
          ...
          <TabPanel>
            <Descriptions bordered column={1}>
              ...
              {agent.agent_card_params?.capabilities
                ?.stateTransitionHistory && (
                <Descriptions.Item label="State Transition History">
                  Yes
                </Descriptions.Item>
              )}
              ...
              {agent.agent_card_params?.iconUrl && (
                <Descriptions.Item label="Icon URL">
                  {agent.agent_card_params.iconUrl}
                </Descriptions.Item>
              )}
              ...
              <Descriptions.Item label="TPM Limit">
                {agent.tpm_limit ?? "Unlimited"}
              </Descriptions.Item>
              <Descriptions.Item label="RPM Limit">
