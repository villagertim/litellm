...
import { Collapse, Form, Input, Select, Space, Switch, Tooltip } from "antd";
    ...
    <>
      ...
      <Collapse defaultActiveKey={["basic"]} style={{ marginBottom: 16 }}>
        ...
        {shouldShow(AGENT_FORM_CONFIG.basic.key) && (
          <Panel
            header={`${AGENT_FORM_CONFIG.basic.title} (Required)`}
        ...
        {shouldShow(AGENT_FORM_CONFIG.skills.key) && (
          <Panel
            header={`${AGENT_FORM_CONFIG.skills.title} (Required)`}
        ...
        {shouldShow(AGENT_FORM_CONFIG.capabilities.key) && (
          <Panel
            header={AGENT_FORM_CONFIG.capabilities.title}
        ...
        {shouldShow(AGENT_FORM_CONFIG.optional.key) && (
          <Panel
            header={AGENT_FORM_CONFIG.optional.title}
        ...
        {shouldShow(AGENT_FORM_CONFIG.litellm.key) && (
          <Panel
            header={AGENT_FORM_CONFIG.litellm.title}
