...
import { type PromptSpec, getPromptVersions } from "../../networking";
        ...
        <List
          ...
          renderItem={(item, index) => {
            ...
            const itemVersionNum =
              item.version ||
              Number.parseInt(getVersionNumber(item).replace("v", ""));
            ...
            if (activeVersionId) {
              if (activeVersionId.includes(".v")) {
                activeVersionNum = Number.parseInt(
                  activeVersionId.split(".v")[1],
                );
              } else if (activeVersionId.includes("_v")) {
                activeVersionNum = Number.parseInt(
                  activeVersionId.split("_v")[1],
                );
              }
            }
